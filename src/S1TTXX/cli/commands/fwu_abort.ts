...
/**
 * CMD_FWU_ABORT (0x15): bootloader-side. Tears down the active session.
 * The header page is already erased (FWU_BEGIN did it on the way in), so
 * the slot stays invalid until the next successful update. Use this to
 * cleanly back out of a partial update before retrying.
 */
