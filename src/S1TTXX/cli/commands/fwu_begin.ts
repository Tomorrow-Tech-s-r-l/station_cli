...
/**
 * CMD_FWU_BEGIN (0x12): bootloader-side. Tears down any previous session,
 * erases the app header page (so the slot is marked invalid for the
 * duration of the update), and arms a new session. The image size, CRC32,
 * and version travel in the request body; nothing else flows over the
 * pogo wire — the body bytes themselves come in via CMD_FWU_DATA.
 */
