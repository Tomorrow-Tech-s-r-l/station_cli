...
function getCommandName(commandCode: number): string {
  const commandNames: { [key: number]: string } = {
    ...
    [CMD_STATION_FWU_ENTER_CODE]: "STATION_FWU_ENTER",
    [CMD_STATION_FWU_HELLO_CODE]: "STATION_FWU_HELLO",
    [CMD_STATION_FWU_BEGIN_CODE]: "STATION_FWU_BEGIN",
    [CMD_STATION_FWU_DATA_CODE]:  "STATION_FWU_DATA",
    [CMD_STATION_FWU_END_CODE]:   "STATION_FWU_END",
    [CMD_STATION_FWU_ABORT_CODE]: "STATION_FWU_ABORT",
    [CMD_STATION_FWU_EXIT_CODE]:  "STATION_FWU_EXIT",
  };
