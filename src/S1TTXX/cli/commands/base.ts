...
function getCommandName(commandCode: number): string {
  const commandNames: { [key: number]: string } = {
    ...
    [CMD_PB_ENTER_BOOT_CODE]: "PB_ENTER_BOOT",
    [CMD_PB_FWU_HELLO_CODE]:  "PB_FWU_HELLO",
    [CMD_PB_FWU_BEGIN_CODE]:  "PB_FWU_BEGIN",
    [CMD_PB_FWU_DATA_CODE]:   "PB_FWU_DATA",
    [CMD_PB_FWU_END_CODE]:    "PB_FWU_END",
    [CMD_PB_FWU_ABORT_CODE]:  "PB_FWU_ABORT",
    [CMD_PB_FWU_EXIT_CODE]:   "PB_FWU_EXIT",
    [CMD_FWU_ENTER_CODE]: "FWU_ENTER",
